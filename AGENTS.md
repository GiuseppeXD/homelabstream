...
- Mudancas no dashboard ficam em `scripts/webui-legendas/main.py`, `config.py`, `db.py`, `jobs.py`, `scanner.py`, `watcher.py`, `translate.py`, `extractor.py`, `docker_utils.py`, `templates/` e `static/`.
